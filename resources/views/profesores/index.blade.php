    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Control de Maestros</h4>
                            ...
                            <div class="row mx-0 align-items-center">
                                ...
                                <div class="col-12">
                                    <div class="float-right">
                                        <button class="btn btn-primary dropdown-toggle arrow-none waves-effect waves-light float-right" data-toggle="modal" data-target="#modal_crear_profesor" type="button">
...
{{-- Modal Agregar --}}
<div class="modal fade bs-example-modal-lg" id="modal_crear_profesor" tabindex="-1" role="dialog" aria-labelledby="modal-blade-title" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="modal-blade-title">Agregar Maestro</h5>
